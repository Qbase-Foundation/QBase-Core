...
Only requiring some minor changes is qbase.cpp.
...
Changes to qbase.cpp
----------------------
qbase.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
