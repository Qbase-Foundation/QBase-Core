...
This mechanism has been integrated into Bitcore-Node-Qbase which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qbasecoin/insight-api-qbase#web-socket-api](https://github.com/qbasecoin/insight-api-qbase#web-socket-api) 
* API: [https://github.com/qbasecoin/insight-api-qbase#instantsend-transactions](https://github.com/qbasecoin/insight-api-qbase#instantsend-transactions) 
...
By default, the Qbase Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qbase Core daemon:
