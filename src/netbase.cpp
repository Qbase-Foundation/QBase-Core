...
static bool Socks5(const std::string& strDest, int port, const ProxyCqbasetials *auth, SOCKET& hSocket)
{
...
static bool ConnectThroughProxy(const proxyType &proxy, const std::string& strDest, int port, SOCKET& hSocketRet, int nTimeout, bool *outProxyConnectionFailed)
{
    ...
    if (proxy.randomize_cqbasetials) {
        ProxyCqbasetials random_auth;
