...
2. run qbased with -printalert or -sendalert like this:
   /path/to/qbased -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://qbasecoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Qbase Core:0.12.0.58/"));
