    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Qbase Core");
    ...
    QString copyrightTextQbase   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Qbase Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextQbase);
