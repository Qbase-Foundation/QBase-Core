    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Qbase Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Qbase address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qbase: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Qbase Core"), this);
    aboutAction->setStatusTip(tr("Show information about Qbase Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qbase Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Qbase addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Qbase addresses"));
    ...
    openAction->setStatusTip(tr("Open a qbase: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Qbase Core help message to get a list with possible Qbase Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Qbase Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Qbase network", "", count));
}
...
{
    QString strTitle = tr("Qbase Core"); // default title
