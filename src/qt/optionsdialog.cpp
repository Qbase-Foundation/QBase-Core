    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QBASE-light"), QVariant("light"));
    ui->theme->addItem(QString("QBASE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QBASE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QBASE-traditional"), QVariant("trad"));
