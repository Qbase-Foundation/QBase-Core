    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Qbase Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Qbase Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  qbase-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Qbase in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an qbasetive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 QBASE, 0.1 QBASE, 1 QBASE and 10 QBASE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://qbasecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://qbasecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Qbase Core is shutting down...") + "<br /><br />" +
