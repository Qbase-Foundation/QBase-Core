...
{
public:
    /// Is the input associated with this public key? (and there is 10000 QBASE - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of qbase.
