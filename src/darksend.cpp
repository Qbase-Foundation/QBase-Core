...
{
    if(fLiteMode) return; // ignore all Qbase related functionality
...
/*
    ...
    allow endless transaction that would bloat Qbase and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("qbase-privatesend");
