...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QbaseNetwork") type = QbaseNetwork;
    if(strType == "QbaseNetworkVariable") type = QbaseNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QbaseNetwork) s = "QbaseNetwork";
    if(type == QbaseNetworkVariable) s = "QbaseNetworkVariable";
