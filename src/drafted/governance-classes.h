 ...
 *
 *   // network
 *   CQbaseNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.qbasecoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQbaseNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QbaseNetwork
// //   -- signature requirements : Key1(User)
// class CQbaseNetworkVariable : public CGovernanceObject
// {
// private:
