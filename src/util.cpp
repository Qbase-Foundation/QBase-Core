...
const char * const BITCOIN_CONF_FILENAME = "qbase.conf";
const char * const BITCOIN_PID_FILENAME = "qbased.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "qbase" is a composite category enabling all Qbase-related debug output
            if(ptrCategory->count(string("qbase"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\QbaseCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\QbaseCore
    // Mac: ~/Library/Application Support/QbaseCore
    // Unix: ~/.qbasecore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "QbaseCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/QbaseCore";
#else
    // Unix
    return pathRet / ".qbasecore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty qbase.conf if it does not excist
        ...
        if (configFile != NULL) {
        	...
        	LogPrintf("qbase.conf file not found or can't be created\n");
    ...
    {
        // Don't overwrite existing settings so command line settings override qbase.conf
...
void AddSeedsToConfigFile(FILE* configFile) {
	...
	fprintf(configFile,"addnode=144.202.109.173:13981\r\n");
	fprintf(configFile,"addnode=140.143.129.82:13981\r\n");
	fprintf(configFile,"addnode=113.243.73.116:13981\r\n");
	fprintf(configFile,"addnode=45.32.226.148:13981\r\n");
	fprintf(configFile,"addnode=141.101.14.64:13981\r\n");
	fprintf(configFile,"addnode=84.55.19.210:13981\r\n");
	fprintf(configFile,"addnode=108.61.142.63:13981\r\n");
	fprintf(configFile,"addnode=8.12.22.78:13981\r\n");
	fprintf(configFile,"addnode=108.160.138.215:13981\r\n");
	...
	fprintf(configFile,"addnode=167.88.163.202:13981\r\n");
	fprintf(configFile,"addnode=167.88.163.204:13981\r\n");
	fprintf(configFile,"addnode=35.178.15.243:13981\r\n");
	fprintf(configFile,"addnode=155.94.174.81:13981\r\n");
}
